                            ...
                            <div className="contact-info-list">
                                <ul className="ul-reset">
                                    ...
                                    <li className="d-flex flex-wrap align-items-center position-relative wow fadeInRight"
                                        ...
                                        <div className="text-box">
                                            <p>Address</p> 
                                            <a href="https://maps.app.goo.gl/QLeGLokpPVMUeqXt9" target="_blank">11/30, Kalpataru Colony Rd, Shramasafalya Colony, Varkhade, Karve Nagar, Pune, Maharashtra 411052</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
